...
class ThreeSecondStore implements OnlineShop, FashionShop {
    ...
    ThreeSecondStore(String productName, String size, int price, String paymentMethod, String availableCourier) {
